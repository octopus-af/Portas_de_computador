...
O foco do estudo foi compreender o funcionamento das portas de rede, sua importância na comunicação entre dispositivos e seu papel fundamental na área de Cybersecurity. 
...
Este projeto reforça minha base em redes e segurança, sendo um passo importante na minha transição para a área de Cybersecurity, especialmente em atividades de monitoramento e análise de eventos.
